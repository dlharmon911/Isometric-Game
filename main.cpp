...
{    
    ...
    drawWindow(buffer, 0, WINDOW_TOP, BUFFER_WIDTH - 1, BUFFER_HEIGHT - 1, UP);
...
void drawScreen(BITMAP *bmp)
{
    ...
    acquire_screen();
    stretch_blit(bmp, screen, 0, 0, BUFFER_WIDTH, BUFFER_HEIGHT, 0, 0, SCREEN_W, SCREEN_H);
    release_screen();
