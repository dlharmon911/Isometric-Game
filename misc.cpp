...
bool pass()
{
    ...
    under=getBehind(buffer, BUFFER_WIDTH/2-l/2-10, BUFFER_HEIGHT/2-20, BUFFER_WIDTH/2+l/2+10, BUFFER_HEIGHT/2+20);
    drawWindow(buffer, BUFFER_WIDTH/2-l/2-10, BUFFER_HEIGHT/2-20, BUFFER_WIDTH/2+l/2+10, BUFFER_HEIGHT/2+20, UP);
    dtextout_centre(buffer, my_font, str, BUFFER_WIDTH/2, (BUFFER_HEIGHT-FONT_H)/2, COLOR_UP, COLOR_DOWN);

    drawScreen(buffer);
    putBehind(under, buffer, BUFFER_WIDTH/2-l/2-10, BUFFER_HEIGHT/2-20);
    clear_keybuf();
    do
    {
        if (keypressed())
    ...
    under=getBehind(buffer, BUFFER_WIDTH/2-l/2-10, BUFFER_HEIGHT/2-20, BUFFER_WIDTH/2+l/2+10, BUFFER_HEIGHT/2+20);
    drawWindow(buffer, BUFFER_WIDTH/2-l/2-10, BUFFER_HEIGHT/2-20, BUFFER_WIDTH/2+l/2+10, BUFFER_HEIGHT/2+20, UP);
    dtextout_centre(buffer, my_font, "Password Incorrect!", BUFFER_WIDTH/2, (BUFFER_HEIGHT-FONT_H)/2, COLOR_UP, COLOR_DOWN);
